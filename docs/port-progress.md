...
| **Active CI** | Run 527 (`db7713fe`) completed ✅ — frame_0129=80% nonblack, frame_0200=0% (daTitle D=C0 TEV inject using unset GX_TEVREG0=[0,0,0]). Fix committed (D=C0 dark fallback → apply_rasc_color, fc4f9789). New CI run pending to verify frame_0200 nonblack ≥ 1%. |
...
| **Goal Milestones** | `GOAL_INTRO_GEOMETRY` ✅, `GOAL_DEPTH_BLEND_ACTIVE` ✅, `GOAL_INTRO_VISIBLE` ✅ (title screen frame 10, 1% nonblack), `GOAL_TITLE_VISIBLE` ⏳ (frame 200 nonblack, pending CI verification of D=C0 fix) |
