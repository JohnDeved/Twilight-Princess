...
void mDoExt_3DlineMat1_c::draw() {
    ...
    for (s32 i = 0; i < mNumLines; i++) {
        mDoExt_3Dline_c* draw_line = (mDoExt_3Dline_c*)((uintptr_t)lines + (mIsDrawn << 2));
        GXSetArray(GX_VA_POS, draw_line->field_0x8, 0xC);
        GXSetArray(GX_VA_NRM, draw_line->field_0x10, 0x3);
        GXSetArray(GX_VA_TEX0, draw_line->field_0x18, 0x8);
