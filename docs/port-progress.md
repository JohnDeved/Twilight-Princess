...
| **Current Step** | Step 5+ — Texture pipeline complete (CI/TLUT decode, wrap/filter, alpha test, scissor, konst) |
| **Last Updated** | 2026-03-01 |
| **Blocking Issue** | Title screen 3D models render; remaining gap is multi-texture stages and full TEV emulation |
