...
| **Current Step** | Step 5+ — rendering accuracy: clearEfb white→black fix applied |
| **Last Updated** | 2026-03-06 |
| **Active CI** | cbf3b4e8 ✅ completed — 17/17 milestones, TITLE gate passing. clearEfb tev_reg_dirty fix pending next CI run. |
...
| **Known rendering gap** | Phase 2 (softpipe, TP_SKIP_DL_DRAWS=1) title/logo frames 10/30/120 = 95% nonblack ✅. Frame 60 = 4% nonblack (logo fade-down). Phase 4 (all draws) frames 30-120 = 4% nonblack (logo visible). Frame 200 = 0% (correctly black — title content rendering pending). |
