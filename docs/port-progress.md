...
| **Active CI** | Run 518 (`d0c03d32`) needs manual approval — fixes centroid gate (draw_calls>1000) and eye placement (vz_max+5000). Expected to produce in_frustum=1 and pct_nonblack>0 at frame 129. |
