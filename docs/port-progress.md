...
| **Active CI** | Run 527 (`db7713fe`) completed ✅ — frame_0129=80% nonblack, frame_0200=0% (daTitle D=C0 TEV inject using unset GX_TEVREG0=[0,0,0]). Fix committed (D=C0 dark fallback → apply_rasc_color). Pending next CI run. |
